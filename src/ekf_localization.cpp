...
unique_ptr<VectorXd> EKFLocalization::residual(const shared_ptr<VectorXd> &a,
                                               const shared_ptr<VectorXd> &b) {
...
shared_ptr<VectorXd> EKFLocalization::move(const shared_ptr<VectorXd> &x, const shared_ptr<VectorXd> &u) {
...
void EKFLocalization::predict(const shared_ptr<VectorXd> &u) {
...
void EKFLocalization::update(const shared_ptr<VectorXd> &z, const shared_ptr<VectorXd> &landmark) {
    ...
    MatrixXd K = PHT * SI;
    shared_ptr<VectorXd> hx = Hx(this->x, landmark);
    shared_ptr<VectorXd> y = residual(z, hx);
